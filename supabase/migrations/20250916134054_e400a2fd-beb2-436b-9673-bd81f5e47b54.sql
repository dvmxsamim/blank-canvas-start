...
CREATE POLICY "Only admins can manage genres" ON public.genres FOR ALL USING (public.is_admin());

-- RLS Policies for languages
CREATE POLICY "Anyone can view languages" ON public.languages FOR SELECT USING (true);
CREATE POLICY "Only admins can manage languages" ON public.languages FOR ALL USING (public.is_admin());

-- RLS Policies for artists
CREATE POLICY "Anyone can view artists" ON public.artists FOR SELECT USING (true);
CREATE POLICY "Only admins can manage artists" ON public.artists FOR ALL USING (public.is_admin());

-- RLS Policies for albums
CREATE POLICY "Anyone can view albums" ON public.albums FOR SELECT USING (true);
CREATE POLICY "Only admins can manage albums" ON public.albums FOR ALL USING (public.is_admin());
...
CREATE POLICY "Only admins can manage songs" ON public.songs FOR INSERT USING (public.is_admin());
...
CREATE POLICY "Only admins can manage song_artists" ON public.song_artists FOR ALL USING (public.is_admin());

CREATE POLICY "Anyone can view album_songs" ON public.album_songs FOR SELECT USING (true);
CREATE POLICY "Only admins can manage album_songs" ON public.album_songs FOR ALL USING (public.is_admin());
...
CREATE POLICY "Users can manage playlist_songs for their playlists" ON public.playlist_songs FOR ALL USING (
  EXISTS (
    SELECT 1 FROM public.playlists p 
...
CREATE POLICY "Users can manage their own likes" ON public.likes FOR ALL USING (user_id = auth.uid());
...
CREATE POLICY "Users can manage their own shares" ON public.shares FOR ALL USING (user_id = auth.uid());
...
CREATE POLICY "Only admins can manage featured content" ON public.featured_content FOR ALL USING (public.is_admin());
